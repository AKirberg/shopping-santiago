...
export const localizedCopy = {
  es: {
    ...
    duration: "Tiempo recomendado", official: "Sitio oficial",
    editorial: "Guía editorial", comparison: "Comparación", shoppingRoute: "Ruta de compras",
    seoSuffix: { mall: "Horarios, tiendas y cómo llegar", outlet: "Outlet en Santiago", route: "Ruta de compras en Santiago", guide: "Guía de compras en Santiago", comparison: "Comparación de malls en Santiago" },
    hub: {
  ...
  pt: {
    ...
    duration: "Tempo recomendado", official: "Site oficial",
    editorial: "Guia editorial", comparison: "Comparação", shoppingRoute: "Roteiro de compras",
    seoSuffix: { mall: "Horários, lojas e como chegar", outlet: "Outlet em Santiago", route: "Roteiro de compras em Santiago", guide: "Guia de compras em Santiago", comparison: "Comparação de shoppings em Santiago" },
    hub: {
  ...
  en: {
    ...
    duration: "Recommended time", official: "Official website",
    editorial: "Editorial guide", comparison: "Comparison", shoppingRoute: "Shopping route",
    seoSuffix: { mall: "Opening hours, stores and directions", outlet: "Outlet in Santiago", route: "Shopping route in Santiago", guide: "Shopping guide to Santiago", comparison: "Santiago mall comparison" },
    hub: {
