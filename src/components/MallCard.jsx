import { BadgeCheck, Car, Clock, ExternalLink, MapPin, Star, TrainFront } from "lucide-react";
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <div className="mt-3 rounded-xl bg-mist px-3.5 py-2.5">
          <p className="text-xs font-bold text-ink/60">
            <span className="font-extrabold text-ink/40 uppercase tracking-wider text-xs">Mejor para · </span>
        ...
        <div className="mt-3 flex flex-wrap items-center gap-x-3 gap-y-1 text-xs font-semibold text-ink/45">
          <span className="flex items-center gap-1"><Clock size={12} /> {mall.recommendedTime}</span>
