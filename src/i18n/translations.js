export const translations = {
  es: {
    ...
    quiz: {
      ...
      routeModeHint: "Con 3 a 4 horas puedes elegir 2 malls; con medio día o el día completo puedes agregar más.",
      routeOrderLabel: "Orden de la ruta",
      routeTimeLabel: "Tiempo total de compras",
      routeTravelLabel: "Traslados estimados",
      routeTotalLabel: "Tiempo total estimado",
      routeFitsTime: "Cabe dentro del tiempo que elegiste, sin contar traslados.",
      routeExceedsTime: "Supera el tiempo disponible; considera quitar un mall.",
      routeOrderRecommended: "Orden lógico / recomendable",
      routeOrderReview: "Conviene revisar el orden",
      routeChangeOrder: "Cambiar",
      routeOrderRecommendedHint: "La secuencia elegida sigue un recorrido eficiente desde tu ubicación.",
      routeOrderReviewHint: "Puedes desmarcar y volver a seleccionar para mejorar el recorrido.",
      routeOrderPending: "Agrega otro mall para evaluar el orden del recorrido.",
      routeSelectMore: "Selecciona al menos 2 malls para crear la ruta.",
      routeCta: "Crear ruta en Google Maps",
      mobile: {
        edit: "Editar",
        step: "Paso {step} de {total}",
        resultsStep: "Tu recomendación",
        preferences: "Preferencias",
        multipleChoice: "Puedes elegir más de una opción.",
        back: "Volver",
        continue: "Continuar",
        bestMatch: "Mejor coincidencia",
        yourRecommendation: "Tu mall recomendado",
        editChoices: "Editar elecciones",
        chooseMall: "Elegir este mall",
        viewMall: "Ver ficha",
        addToRoute: "Agregar a mi ruta",
        added: "Agregado",
        routeLimit: "Máximo {count}",
        shortVisit: "Para una visita corta, te recomendamos elegir un mall y aprovechar mejor tu tiempo.",
        seeAlternatives: "Ver otras opciones",
        noResults: "No encontramos una recomendación para estas preferencias.",
        myRoute: "Mi ruta",
        mallSingle: "mall elegido",
        mallPlural: "malls elegidos",
        routeReady: "Tu ruta de compras",
        routeComplete: "Tu ruta está lista para abrirse en Google Maps.",
        optimizedOrder: "El orden está optimizado desde tu ubicación.",
        routeDistance: "Trayecto estimado entre paradas",
    ...
    mallCard: {
      ...
      shopeandoScore: "Puntuación editorial de Shopeando",
    ...
    reviews: {
      shopeandoTitle: "Opiniones en Shopeando", subtitle: "Comparte tu experiencia para ayudar a otros viajeros.",
      googleTitle: "Calificación en Google Maps", googleSubtitle: "La valoración pública de Google Maps se muestra por separado.",
      googleCount: "{count} reseñas en Google Maps", googleLoading: "Cargando calificación de Google Maps…",
      googleUnavailable: "No pudimos cargar la calificación de Google Maps.", googleOpen: "Abrir Google Maps",
      shopeandoLabel: "Shopeando", shopeandoNoReviews: "Shopeando: sin opiniones",
      shopeandoSummary: "Shopeando: {average} de 5 según {count} opiniones",
      ...
      sourceSummary: "{average} de 5 · {source}", googleSource: "Google Maps", shopeandoSource: "Shopeando",
  ...
  pt: {
    ...
    quiz: {
      ...
      routeModeHint: "Com 3 a 4 horas você pode escolher 2 malls; com meio dia ou o dia inteiro pode adicionar mais.",
      routeOrderLabel: "Ordem da rota",
      routeTimeLabel: "Tempo total de compras",
      routeTravelLabel: "Deslocamentos estimados",
      routeTotalLabel: "Tempo total estimado",
      routeFitsTime: "Cabe no tempo escolhido, sem contar os deslocamentos.",
      routeExceedsTime: "Excede o tempo disponível; considere retirar um mall.",
      routeOrderRecommended: "Ordem lógica / recomendada",
      routeOrderReview: "Vale revisar a ordem",
      routeChangeOrder: "Mudar",
      routeOrderRecommendedHint: "A sequência escolhida segue um percurso eficiente a partir da sua localização.",
      routeOrderReviewHint: "Você pode desmarcar e selecionar novamente para melhorar o percurso.",
      routeOrderPending: "Adicione outro mall para avaliar a ordem do percurso.",
      ...
      mobile: {
        ...
        resultsStep: "Sua recomendação",
        preferences: "Preferências",
        multipleChoice: "Você pode escolher mais de uma opção.",
        back: "Voltar",
        continue: "Continuar",
        bestMatch: "Melhor combinação",
        yourRecommendation: "Seu mall recomendado",
        editChoices: "Editar escolhas",
        chooseMall: "Escolher este mall",
        viewMall: "Ver detalhes",
        addToRoute: "Adicionar à minha rota",
        added: "Adicionado",
        routeLimit: "Máximo {count}",
        shortVisit: "Para uma visita curta, recomendamos escolher um mall e aproveitar melhor seu tempo.",
        seeAlternatives: "Ver outras opções",
        noResults: "Não encontramos uma recomendação para estas preferências.",
        myRoute: "Minha rota",
        mallSingle: "mall escolhido",
        mallPlural: "malls escolhidos",
        routeReady: "Sua rota de compras",
        routeComplete: "Sua rota está pronta para abrir no Google Maps.",
        optimizedOrder: "A ordem está otimizada a partir da sua localização.",
        routeDistance: "Trajeto estimado entre paradas",
    ...
    mallCard: {
      ...
      shopeandoScore: "Pontuação editorial do Shopeando",
      zoneTuristico: "Zona turística",
    ...
    reviews: {
      shopeandoTitle: "Opiniões no Shopeando", subtitle: "Compartilhe sua experiência e ajude outros viajantes.",
      googleTitle: "Avaliação no Google Maps", googleSubtitle: "A avaliação pública do Google Maps aparece separadamente.",
      googleCount: "{count} avaliações no Google Maps", googleLoading: "Carregando avaliação do Google Maps…",
      googleUnavailable: "Não foi possível carregar a avaliação do Google Maps.", googleOpen: "Abrir Google Maps",
      shopeandoLabel: "Shopeando", shopeandoNoReviews: "Shopeando: sem opiniões",
      shopeandoSummary: "Shopeando: {average} de 5 em {count} opiniões",
      ratingLabel: "Sua nota de 1 a 5", ratingOption: "{score} de 5 sacolas",
      summary: "{average} de 5 em {count} opiniões", count: "{count} opiniões",
      noReviews: "Sem opiniões",
      sourceSummary: "{average} de 5 · {source}", googleSource: "Google Maps", shopeandoSource: "Shopeando",
  ...
  en: {
    ...
    quiz: {
      ...
      routeModeHint: "With 3–4 hours you can choose 2 malls; with half a day or a full day you can add more.",
      routeOrderLabel: "Route order",
      routeTimeLabel: "Total shopping time",
      routeTravelLabel: "Estimated travel time",
      routeTotalLabel: "Estimated total time",
      routeFitsTime: "Fits within your selected time, excluding transfers.",
      routeExceedsTime: "Exceeds the available time; consider removing a mall.",
      routeOrderRecommended: "Logical / recommended order",
      routeOrderReview: "Review the route order",
      routeChangeOrder: "Change",
      routeOrderRecommendedHint: "The selected sequence follows an efficient route from your location.",
      routeOrderReviewHint: "Deselect and select again to improve the route.",
      routeOrderPending: "Add another mall to evaluate the route order.",
      ...
      mobile: {
        ...
        resultsStep: "Your recommendation",
        preferences: "Preferences",
        multipleChoice: "You can choose more than one option.",
        back: "Back",
        continue: "Continue",
        bestMatch: "Best match",
        yourRecommendation: "Your recommended mall",
        editChoices: "Edit choices",
        chooseMall: "Choose this mall",
        viewMall: "View details",
        addToRoute: "Add to my route",
        added: "Added",
        routeLimit: "Maximum {count}",
        shortVisit: "For a short visit, we recommend choosing one mall and making the most of your time.",
        seeAlternatives: "See other options",
        noResults: "We couldn't find a recommendation for these preferences.",
        myRoute: "My route",
        mallSingle: "mall selected",
        mallPlural: "malls selected",
        routeReady: "Your shopping route",
        routeComplete: "Your route is ready to open in Google Maps.",
        optimizedOrder: "The order is optimized from your location.",
        routeDistance: "Estimated distance between stops",
    ...
    mallCard: {
      ...
      shopeandoScore: "Shopeando editorial score",
    ...
    reviews: {
      shopeandoTitle: "Reviews on Shopeando", subtitle: "Share your experience to help other travellers.",
      googleTitle: "Google Maps rating", googleSubtitle: "The public Google Maps rating is shown separately.",
      googleCount: "{count} Google Maps reviews", googleLoading: "Loading Google Maps rating…",
      googleUnavailable: "We could not load the Google Maps rating.", googleOpen: "Open Google Maps",
      shopeandoLabel: "Shopeando", shopeandoNoReviews: "Shopeando: no reviews yet",
      shopeandoSummary: "Shopeando: {average} out of 5 from {count} reviews",
      ...
      sourceSummary: "{average} out of 5 · {source}", googleSource: "Google Maps", shopeandoSource: "Shopeando",
